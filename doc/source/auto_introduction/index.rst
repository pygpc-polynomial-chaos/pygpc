...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
    ...
    :download:`Download all examples in Python source code: auto_introduction_python.zip <//data/hu_emueller/PycharmProjects/pygpc/doc/source/auto_introduction/auto_introduction_python.zip>`



  .. container:: sphx-glr-download

    :download:`Download all examples in Jupyter notebooks: auto_introduction_jupyter.zip <//data/hu_emueller/PycharmProjects/pygpc/doc/source/auto_introduction/auto_introduction_jupyter.zip>`
