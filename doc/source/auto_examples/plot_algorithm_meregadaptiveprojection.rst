.. note::
    ...
    Click :ref:`here <sphx_glr_download_auto_examples_plot_algorithm_meregadaptiveprojection.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_plot_algorithm_meregadaptiveprojection.py:
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Total function evaluation: 0.005074977874755859 sec
    It/Sub-it: 3/2 Performing simulation 01 from 40 [=                                       ] 2.5%
    Gradient evaluation: 0.000789642333984375 sec
    ...
    Total function evaluation: 0.007125139236450195 sec
    It/Sub-it: Domain boundary/N/A Performing simulation 01 from 24 [=                                       ] 4.2%
    Gradient evaluation: 0.0004794597625732422 sec
    Updating classifier ...
    Determine gPC coefficients using 'LarsLasso' solver (gradient enhanced)...
    Determine gPC coefficients using 'LarsLasso' solver (gradient enhanced)...
    -> Domain: 0 absolute nrmsd error = 0.3815403477720444
    -> Domain: 1 absolute nrmsd error = 0.10470826335573939
    Determine gPC coefficients using 'LarsLasso' solver (gradient enhanced)...
    Determine gPC coefficients using 'LarsLasso' solver (gradient enhanced)...
...
.. image:: /auto_examples/images/sphx_glr_plot_algorithm_meregadaptiveprojection_001.png
...
.. image:: /auto_examples/images/sphx_glr_plot_algorithm_meregadaptiveprojection_002.png
    :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    > Maximum NRMSD (gpc vs original): 0.047%
...
.. _sphx_glr_download_auto_examples_plot_algorithm_meregadaptiveprojection.py:
