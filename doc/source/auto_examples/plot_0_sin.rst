.. note::
    ...
    Click :ref:`here <sphx_glr_download_auto_examples_plot_0_sin.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_plot_0_sin.py:
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /data/pt_01756/software/git/pygpc/examples/plot_0_sin.py:53: UserWarning: Matplotlib is currently using agg, which is a non-GUI backend, so cannot show the figure.
      plt.show()
...
.. _sphx_glr_download_auto_examples_plot_0_sin.py:
