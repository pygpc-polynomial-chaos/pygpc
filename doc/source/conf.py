...
sphinx_gallery_conf = {
    'examples_dirs': ['../../examples/introduction', '../../examples/gpc', '../../examples/algorithms', '../../examples/features', '../../examples/examples', '../../examples/sampling'],   # path to your example scripts
