...
class Problem:
    ...
    ----------
    model: Model object
        Model object instance of model to investigate (derived from AbstractModel class)
    parameters: ORderedDict
        Dictionary containing the model parameters as keys and for:
        - constants: value as float
    ...
    def __init__(self, model, parameters):
        ...
        # TODO: determine number of output quantities from model
        self.N_out = None
        model.simulate
