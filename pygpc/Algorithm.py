...
class Algorithm:
    ...
    def run(self):
        ...
        """
        return getattr(self, self.algorithm)(self.options)

    def reg_adaptive_tms(self, pdf_type, pdf_shape, limits, func, args=(), fname=None,
    ...
    def reg_adaptive(self, problem,
        ...
        worker_objs = []
        global_task_counter = process_manager.Value('i',
                                                    0)  # global counter used by all threads to keep track of the progress
